"use client";
import { AddTaskWrapper } from "@/src/components/add-tasks/add-task-button";
import SuggestMissingTasks from "@/src/components/add-tasks/suggest-tasks";
import MobileNav from "@/src/components/nav/mobile-nav";
import SideBar from "@/src/components/nav/side-bar";
import DeleteProject from "@/src/components/projects/delete-project";
import CompletedTodos from "@/src/components/todos/completed-todos";
